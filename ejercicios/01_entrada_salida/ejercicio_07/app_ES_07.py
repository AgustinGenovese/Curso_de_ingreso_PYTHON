...
class App(customtkinter.CTk):
    ...
    def btn_sumar_on_click(self):
        ...
        """primera forma simplificada"""
        Numero2texto = (self.txt_operador_b.get())
        Numero2numero = int(Numero2texto)
        """Segunda forma"""
        SUMA = Numero1 + Numero2numero
        alert(title="Resultado", message= f"El resultado es {SUMA}")

    def btn_restar_on_click(self):
        Numero1 = int(self.txt_operador_a.get()) 
        Numero2 = int(self.txt_operador_b.get())
        RESTA = Numero1 - Numero2
        alert(title="Resultado", message= f"El resultado es {RESTA}")

    def btn_multiplicar_on_click(self):
        Numero1 = int(self.txt_operador_a.get()) 
        Numero2 = int(self.txt_operador_b.get())
        Producto = Numero1 * Numero2
        alert(title="Resultado", message= f"El resultado es {Producto}")

    def btn_dividir_on_click(self):
        Numero1 = int(self.txt_operador_a.get()) 
        Numero2 = int(self.txt_operador_b.get())
        Division = Numero1 / Numero2
        alert(title="Resultado", message= f"El resultado es {Division}")
